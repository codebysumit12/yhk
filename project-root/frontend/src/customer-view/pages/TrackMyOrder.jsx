              ...
              <div className="section-card timeline-card">
                  ...
                  <div className="progress-indicator">
                    ...
                    <div className="progress-bar">
                      <div
                        ...
                        style={{
                          width: `${((currentStatusIndex + 1) / orderStatuses.length) * 100}%`,
                ...
                <div className="status-timeline">
                  {orderStatuses.map((status, index) => {
                    ...
                    return (
                      <div
                        key={status}
                        className={`timeline-item ${isCompleted ? 'completed' : ''} ${isCurrent ? 'current' : ''} ${selectedOrder.status === 'cancelled' && !isCompleted ? 'cancelled' : ''}`}
                      >
                        ...
                        <div className="timeline-content">
                          <div className="timeline-title">
                            <h4 style={{ color: isCompleted ? config.color : '#64748b' }}>
                              {config.label}
                            </h4>
                  ...
                  <div className="estimated-time-card">
                    ...
                    <div className="eta-content">
                      ...
                      <div className="eta-countdown">
                        {(() => {
                          const now = new Date();
                          const eta = new Date(selectedOrder.delivery.estimatedTime);
                          const diffMinutes = Math.floor((eta - now) / 60000);
                          if (diffMinutes > 0) {
                            const hours = Math.floor(diffMinutes / 60);
                            const mins = diffMinutes % 60;
                            return hours > 0 ? `${hours}h ${mins}m remaining` : `${mins} minutes remaining`;
                          }
                ...
                {selectedOrder.delivery?.deliveryPerson &&
                  ...
                  <div className="delivery-person-card">
                      ...
                      <div className="delivery-info">
                        <div className="info-group">
                          ...
                          <div>
                            ...
                            <div className="info-value">{selectedOrder.delivery.deliveryPerson.name}</div>
                          </div>
                        </div>
                        <div className="info-group">
                          <span className="info-icon">📱</span>
                          <div>
                            ...
                            <div className="info-value">{selectedOrder.delivery.deliveryPerson.phone}</div>
                          </div>
                        </div>
                        <div className="info-group">
                          ...
                          <div>
                            ...
                            <div className="info-value">{selectedOrder.delivery.deliveryPerson.vehicleNumber}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <a
                      href={`tel:${selectedOrder.delivery.deliveryPerson.phone}`}
