  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const itemsResponse = await fetch(`${API_URL}/items?type=desserts&isAvailable=true`);
  ...
  if (loading) {
    return (
      <div className="menu-page">
        <YHKLoader message="Loading desserts..." />
      </div>
    );
  }
          ...
          <section className="menu-hero" style={{
            ...
            <div className="menu-hero-content">
              <button className="back-btn" onClick={handleBackToMenu}>
                <i className="fas fa-arrow-left"></i> Back to Desserts
              </button>
        ...
        {heroBanner?.mediaType === 'video' ? (
          <section className="related-hero related-hero-video">
            ...
            <div className="related-hero-content">
              ...
              <h1>🍰 Desserts</h1>
              <p>Indulge in our sweet and delightful desserts</p>
            </div>
          </section>
        ) : (
          <section 
                ...
                return (
                  ...
                  >
                    ...
                    <div className="menu-item-info">
                      <h4>{item.name}</h4>
                      <p>{item.description || 'Sweet dessert'}</p>
