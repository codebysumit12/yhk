...
const Smoothies = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const itemsResponse = await fetch(`${API_URL}/items?type=smoothies&isAvailable=true`);
  ...
  const handleItemClick = (item) => {
    setSelectedItem(item);
    navigate(`/smoothies?id=${item._id}`);
  };
  ...
  const bannerImage = heroBanner?.mediaUrl || 'https://images.unsplash.com/photo-1502741126161-b048400d08c5?w=1920&q=80';

  if (loading) {
    return (
      <div className="menu-page">
        <YHKLoader message="Loading smoothies..." />
      </div>
    );
  }
          ...
          <section className="menu-hero" style={{
            ...
            <div className="menu-hero-content">
              <button className="back-btn" onClick={handleBackToMenu}>
                <i className="fas fa-arrow-left"></i> Back to Smoothies
              </button>
        ...
        {heroBanner?.mediaType === 'video' ? (
          <section className="related-hero related-hero-video">
            ...
            <div className="related-hero-content">
              ...
              <h1>🥤 Smoothies</h1>
              <p>Refresh yourself with our healthy smoothies</p>
            </div>
          </section>
        ) : (
          <section 
                ...
                return (
                  ...
                  >
                    ...
                    <div className="menu-item-info">
                      <h4>{item.name}</h4>
                      <p>{item.description || 'Healthy smoothie'}</p>
